...
const char* DEVICE_ID = "ESP32-NODE-03";
...
// Default GPS coordinates for Node 3 - Bettamugilalam
// These are used if GPS has no fix
double latitude = 12.5195;

double longitude = 77.8200;
...
void setup()
{
  ...
  Serial.println("       NODE 03 - Bettamugilalam");
  Serial.println("========================================");
  ...
  // ========================================================
  // GPS COORDINATES (Node 3 - Bettamugilalam)
  // ========================================================
  ...
  Serial.println("  Latitude:  12.5195");
  Serial.println("  Longitude: 77.8200");
  ...
  Serial.println();
  Serial.println("LOCATION  : Bettamugilalam, Krishnagiri, TN");
  Serial.println("GPS LAT   : 12.5195");
  Serial.println("GPS LON   : 77.8200");
