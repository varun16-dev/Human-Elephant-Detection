...
const char* DEVICE_ID = "ESP32-NODE-02";
...
// Default GPS coordinates for Node 2 - Begihalli
// These are used if GPS has no fix
double latitude = 12.79213;

double longitude = 77.61622;
...
void setup()
{
  ...
  Serial.println("       NODE 02 - Begihalli");
  Serial.println("========================================");
  ...
  // ========================================================
  // GPS COORDINATES (Node 2 - Begihalli)
  // ========================================================
  ...
  Serial.println("  Latitude:  12.79213");
  Serial.println("  Longitude: 77.61622");
  ...
  Serial.println();
  Serial.println("LOCATION  : Begihalli, Anekal Taluk, KA");
  Serial.println("GPS LAT   : 12.79213");
  Serial.println("GPS LON   : 77.61622");
